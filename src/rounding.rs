...
///
/// Returns a1.
pub fn decompose<const GAMMA2: usize>(a0: &mut i32, a: i32) -> i32 {
  let mut a1 = (a + 127) >> 7;
  if GAMMA2 == (Q - 1) / 32 {
    a1 = (a1 * 1025 + (1 << 21)) >> 22;
    a1 &= 15;
...
pub fn make_hint<const GAMMA2: usize>(a0: i32, a1: i32) -> u8 {
...
pub fn use_hint<const GAMMA2: usize>(a: i32, hint: u8) -> i32 {
  let mut a0 = 0i32;
  let a1 = decompose::<GAMMA2>(&mut a0, a);
  if hint == 0 {
    return a1;
  }
